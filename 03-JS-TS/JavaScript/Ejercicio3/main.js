const winnerByYear = (arr, year) => {
    ...
    return topThree.map(obj => obj.name);
  };
...
console.log("1998", winnerByYear(data, 1998)); // [ 'Douglass', 'Randy', 'Monroe' ]
console.log("1999", winnerByYear(data, 1999)); // [ 'Graciela', 'Ervin', 'Maxie' ]
console.log("2000", winnerByYear(data, 2000)); // [ 'Lettie', 'Eddy', 'Emilee' ]
console.log("2001", winnerByYear(data, 2001)); // [ 'Dino', 'Sam', 'Eleanora' ]
console.log("2002", winnerByYear(data, 2002)); // [ 'Sean', 'Lang', 'Coleen' ]
console.log("2003", winnerByYear(data, 2003)); // [ 'Brianna', 'Francene', 'Everett' ]
console.log("2004", winnerByYear(data, 2004)); // []